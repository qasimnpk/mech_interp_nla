...
CURRENT STAGE: ROUND 5 — P1 (7B verbalization + AR scoring).
...
P1   7B greedy verbalization + AR scoring (own / shuffled / 27B text) ..... RUNNING
P2   claim annotation of the 8 7B explanations (protocol verbatim) ....... PENDING
