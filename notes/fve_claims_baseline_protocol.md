...
## 6. Not in the baseline (planned next)
Paraphrase-averaged deletion penalty (light + aggressive rewrites of each sentence, same deletion, mean of the three penalties);
the 27B run; any classifier.
